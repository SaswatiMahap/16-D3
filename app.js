...
var chosenSAxis = "poverty";
var chosenMAxis = "income"
...
function updateToolTip(chosenXAxis, circlesGroup) {
  ...
  if (chosenXAxis === "healthcare") {
    var label = "State Income :";
  }
  else {
    var label = "State Income Level :";
  }
  ...
  var toolTip = d3.tip()
    ...
    .offset([80, -60])
    .html(function(d) {
      return (`${d.state}<br>${label} ${d[chosenMAxis]}`);
    });
...
d3.csv("hairData.csv", function(err, hairData) {
  ...
  var albumsLabel = labelsGroup.append("text")
    ...
    .text("State Income is the circle size");
